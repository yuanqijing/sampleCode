module github.com/yuanqijing/sampleCode

go 1.17

require (
	github.com/Kindling-project/kindling/collector v0.0.0-20220419020546-bf76b1d64d8b
	k8s.io/klog/v2 v2.60.1
)

require (
	github.com/DataDog/ebpf v0.0.0-20220301203322-3fc9ab3b8daf // indirect
	...
	go.opentelemetry.io/otel/exporters/stdout/stdoutmetric v0.25.0 // indirect
